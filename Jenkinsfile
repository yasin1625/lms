    ...
    stages {
        stage('Code Quality') {
            steps {
                ...
                sh 'cd webapp && sudo docker run --rm -e SONAR_HOST_URL="http://35.90.115.123:9000" -v ".:/usr/src" -e SONAR_TOKEN="sqp_0c925e15ffdee0c9be1d25118167e63fea24b6b4" sonarsource/sonar-scanner-cli -Dsonar.projectKey=lms' 

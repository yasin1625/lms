    ...
    stages {
        stage('Sonar Analysis') {
            steps {
                ...
                sh 'cd webapp && sudo docker run  --rm -e SONAR_HOST_URL="http://34.214.127.143:9000" -e SONAR_LOGIN="sqp_31a2a065a5c706f2d31e4da19e61b346232ab619"  -v ".:/usr/src" sonarsource/sonar-scanner-cli:4.9 -Dsonar.projectKey=lms'
